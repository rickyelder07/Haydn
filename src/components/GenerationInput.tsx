...
export function GenerationInput() {
  ...
  const examplePrompts = [
    'create a chill lofi hip hop beat',
    'make an upbeat jazz tune in Bb',
    'trap beat with dark vibes at 150 BPM',
    'classical piano piece in C major',
    'boom bap instrumental in Am',
  ];

  const buttonText = isLoading ? 'Generating...' : lastError ? 'Retry' : 'Generate';
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="relative">
            ...
            {/* Tooltip */}
            {showTooltip && (
              <div className="absolute left-0 bottom-full mb-2 w-72 p-3 bg-gray-900 border border-gray-700 rounded-lg shadow-lg z-50">
          ...
          <input
            ...
            disabled={isLoading}
            maxLength={500}
            className="flex-1 px-4 py-2 border border-green-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
          />
          ...
          <button
            ...
            className="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium flex items-center gap-2 min-w-[140px] justify-center"
          >
        ...
        {!lastError && tokenUsage && (
          <div className="p-3 bg-green-50 border border-green-200 rounded-lg text-green-700 text-sm">
            <div className="font-medium mb-1">Project generated successfully!</div>
